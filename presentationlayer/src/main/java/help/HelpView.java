    ...
    public Scene create_GUI(){
        ...
        if (translator.getCurrentLanguage() == Language.ENGLISH){
            ...
            txtGame.setText(newLine + "Abschnitt A" + newLine + "Ih dem Bereich sind die jewiilige Spieler mit ihrem Benutzernamä und de aktuelle Punktezahl ersichtlich. De Spieler, wele jewiils am Zug isch, wird durch e grüeni Umrandig hervorghobe."
                    ...
                    + doubleNewLine + "Abschnitt F" + newLine + "Das isch de Nahziehstapel. S'rote Label zeigt d'Ahzahl Karte, weli no im Stapel sind. Falls es kei Karte meh zum zieh git, wird de Ablagstapel gmischt und Karte chömet uf de Nahziehstapel."
                    + doubleNewLine + "Abschnitt G" + newLine + "Das isch de Ablagstapel. All Handkarte sowie all gspielte Karte werdet nachem Endi vom Spielzug uf de Ablagestapel gleit. Die Karte werdet offe higleit, so dass immer die letzt Karte ersichtlich isch. Falls de Ablagestapel leer isch, wird Rücksiite vo ere leere Karte ahzeigt."
            ...
            // Text for Tab Login
            txtLogin.setText(newLine + "Dä jewiilig Spieler muen sich mit sinner Email und sim Passwort ihlogge (Lueg A). Stimmt Email mit em Password überih, führt en Klick uf de Button \"Login\" dä Spieler i Lobby.  "
                    + "Falls no keis Login bestaht, muen de Spieler uf de Button \"Registrierä\" klicke. Initial muen sich jede Spieler vorem erste Spiel registrierä."
